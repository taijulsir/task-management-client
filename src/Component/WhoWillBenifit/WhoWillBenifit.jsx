            ...
            <div className="font-sans">
                ...
                <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8 px-4 mb-6">
                    <div className="bg-gray-100 p-6 rounded-md">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="#007bff" className="w-12 mb-4 inline-block bg-white p-3 rounded-md" viewBox="0 0 32 32">
                    ...
                    <div className="bg-gray-100 p-6 rounded-md">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="#007bff" className="w-12 mb-4 inline-block bg-white p-3 rounded-md" viewBox="0 0 512.001 512.001">
                    ...
                    <div className="bg-gray-100 p-6 rounded-md">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="#007bff" className="w-12 mb-4 inline-block bg-white p-3 rounded-md" viewBox="0 0 24 24">
                    ...
                    <div className="bg-gray-100 p-6 rounded-md">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="#007bff" className="w-12 mb-4 inline-block bg-white p-3 rounded-md" viewBox="0 0 682.667 682.667">
                            <defs>
